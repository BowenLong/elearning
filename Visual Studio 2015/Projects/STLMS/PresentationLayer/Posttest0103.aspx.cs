...
{
    public partial class Posttest0103 : System.Web.UI.Page
    {
        LessonBL lessonbl;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lessonbl.updateincrease(userid, "010301");
                lessonbl.updateRate(userid, "010302", Lesson02);
                lessonbl.updateincrease(userid, "010302");
                lessonbl.updateRate(userid, "010303", Lesson03);
                lessonbl.updateincrease(userid, "010303");
                lessonbl.updateRate(userid, "010304", Lesson04);
                lessonbl.updateincrease(userid, "010304");
                lessonbl.updateRate(userid, "010305", Lesson05);
                lessonbl.updateincrease(userid, "010305");
