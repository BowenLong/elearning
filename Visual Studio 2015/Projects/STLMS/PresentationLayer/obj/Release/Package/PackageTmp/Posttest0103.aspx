<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Posttest0103.aspx.cs" Inherits="PresentationLayer.Posttest0103" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">1.Universal shared values are:</div>
    </div>
    <div class="panel panel-body">
        <div class="checkbox-panel">
      <asp:RadioButtonList CssClass="checkbox" ID="RadioButtonList1" runat="server">
          <asp:ListItem Value="0"> A. A set of values that are applicable within a given culture</asp:ListItem>
        <asp:ListItem Value="1"> B. A set of values that go beyond cultures</asp:ListItem>
        <asp:ListItem Value="0"> C. A set of values that dictates how one has to behave</asp:ListItem>
      </asp:RadioButtonList>
