    ...
    public partial class Posttest : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lessonbl.updateincrease(userid, "010101");
                lessonbl.updateRate(userid, "010102", Lesson010102);
                lessonbl.updateincrease(userid, "010102");
                lessonbl.updateRate(userid, "010103", Lesson010103);
                lessonbl.updateincrease(userid, "010103");
                lessonbl.updateRate(userid, "010104", Lesson010104);
                lessonbl.updateincrease(userid, "010104");
                lessonbl.updateRate(userid, "010105", Lesson010105);
                lessonbl.updateincrease(userid, "010105");
