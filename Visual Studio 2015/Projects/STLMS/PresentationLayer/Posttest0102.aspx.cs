...
{
    public partial class Posttest0102 : System.Web.UI.Page
    {
        LessonBL lessonbl;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                lessonbl.updateincrease(userid, "010201");
                lessonbl.updateRate(userid, "010202", Lesson02);
                lessonbl.updateincrease(userid, "010202");
                lessonbl.updateRate(userid, "010203", Lesson03);
                lessonbl.updateincrease(userid, "010203");
                lessonbl.updateRate(userid, "010204", Lesson04);
                lessonbl.updateincrease(userid, "010204");
                lessonbl.updateRate(userid, "010205", Lesson05);
                lessonbl.updateincrease(userid, "010205");
